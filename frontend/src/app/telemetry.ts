...
export class Telemetry {
  ...
  private flush(final: boolean): void {
    ...
    // Straight to HttpClient: this app has no api-client class, its stores call
    // the backend directly. Empty error handler — a trace that surfaces its own
    // failures interferes with the app it observes.
