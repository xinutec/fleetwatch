...
//! login from a cookie-less browser at all — observed 2026-07-28, when the fleetwatch
//! Android wrapper's WebView lost its NC cookie and could never sign in again.
//!
