//! fleetwatch's own DB-backed human sessions. Nextcloud is touched only at
//! login; every request after that authenticates against this opaque session.
//! (Producers/ingest are separate — they use bearer tokens, see `auth`.)
//!
